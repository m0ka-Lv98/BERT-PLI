...
with open('./data/task2_train/task2_train_labels_2022.json', 'r') as f:
    train_labels = json.load(f)

task2_raw_path = './data/task2_train/'
task2_train_data_path = './data/task2_train/train_data_dummy.json'
task2_val_data_path = './data/task2_train/val_data_dummy.json'
task2_test_data_path = './data/task2_train/test_data_dummy.json'
...
for i, (folder_num, label_list) in enumerate(train_labels.items()):
    ...
    j += len(para_paths)
print(j / 525, train, val, test, support / 525)
