...
random.seed(0)
para_sum = 0
task1_label_path = './data/task1_train_labels_2022.json'
task1_files_path = './data/task1_train_files'
task1_case_para = './data/task1_train_files/train_data.json'

task1_train_data_path = './data/task1_post/train_data_50_dummy.json'
task1_val_data_path = './data/task1_post/val_data_50_dummy.json'
task1_test_data_path = './data/task1_post/test_data_50_dummy.json'
